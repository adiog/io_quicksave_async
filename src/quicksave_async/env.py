...
RESPONSE_QUEUE = os.environ.get('RESPONSE_QUEUE', 'response')
...
IO_QUICKSAVE_PYTHONPATH = os.environ.get('IO_QUICKSAVE_PYTHONPATH', '/io.quicksave.bootstrap/libbeans:/io.quicksave.bootstrap/libbeans/pybeans/:/io.quicksave.bootstrap/plugin-engine:/io.quicksave.bootstrap/plugin-engine/pyengine:/io.quicksave.bootstrap/plugin-engine/quicksave_async')
